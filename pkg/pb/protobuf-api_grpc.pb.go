...
func (c *deviceAgentClient) GetTenants(ctx context.Context, in *GetTenantsRequest, opts ...grpc.CallOption) (*GetTenantsResponse, error) {
	out := new(GetTenantsResponse)
	err := c.cc.Invoke(ctx, "/naisdevice.DeviceAgent/GetTenants", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDeviceAgentServer) GetTenants(context.Context, *GetTenantsRequest) (*GetTenantsResponse, error) {
...
func _DeviceAgent_GetTenants_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTenantsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DeviceAgentServer).GetTenants(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/naisdevice.DeviceAgent/GetTenants",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeviceAgentServer).GetTenants(ctx, req.(*GetTenantsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DeviceAgent_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _DeviceAgent_GetTenants_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		{

...
// NewMockAPIServer_GetGatewayConfigurationServer creates a new instance of MockAPIServer_GetGatewayConfigurationServer. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockAPIServer_GetGatewayConfigurationServer(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockAPIServer_GetGatewayConfigurationServer {
	mock := &MockAPIServer_GetGatewayConfigurationServer{}
	mock.Mock.Test(t)

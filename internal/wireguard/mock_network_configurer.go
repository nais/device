...
// ApplyWireGuardConfig provides a mock function for the type MockNetworkConfigurer
func (_mock *MockNetworkConfigurer) ApplyWireGuardConfig(peers []Peer) error {
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func([]Peer) error); ok {
		r0 = returnFunc(peers)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockNetworkConfigurer_ApplyWireGuardConfig_Call) Return(err error) *MockNetworkConfigurer_ApplyWireGuardConfig_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockNetworkConfigurer_ApplyWireGuardConfig_Call) RunAndReturn(run func(peers []Peer) error) *MockNetworkConfigurer_ApplyWireGuardConfig_Call {
	_c.Call.Return(run)
	return _c
}

// ForwardRoutesV4 provides a mock function for the type MockNetworkConfigurer
func (_mock *MockNetworkConfigurer) ForwardRoutesV4(routes []string) error {
	ret := _mock.Called(routes)
...
func (_c *MockNetworkConfigurer_ForwardRoutesV4_Call) Return(err error) *MockNetworkConfigurer_ForwardRoutesV4_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockNetworkConfigurer_ForwardRoutesV4_Call) RunAndReturn(run func(routes []string) error) *MockNetworkConfigurer_ForwardRoutesV4_Call {
	_c.Call.Return(run)
	return _c
}

// ForwardRoutesV6 provides a mock function for the type MockNetworkConfigurer
func (_mock *MockNetworkConfigurer) ForwardRoutesV6(routes []string) error {
	ret := _mock.Called(routes)
...
func (_c *MockNetworkConfigurer_ForwardRoutesV6_Call) Return(err error) *MockNetworkConfigurer_ForwardRoutesV6_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockNetworkConfigurer_ForwardRoutesV6_Call) RunAndReturn(run func(routes []string) error) *MockNetworkConfigurer_ForwardRoutesV6_Call {
	_c.Call.Return(run)
	return _c
}

// SetupIPTables provides a mock function for the type MockNetworkConfigurer
func (_mock *MockNetworkConfigurer) SetupIPTables() error {
	ret := _mock.Called()
...
func (_c *MockNetworkConfigurer_SetupIPTables_Call) Return(err error) *MockNetworkConfigurer_SetupIPTables_Call {
	_c.Call.Return(err)
	return _c
}
...
// SetupInterface provides a mock function for the type MockNetworkConfigurer
func (_mock *MockNetworkConfigurer) SetupInterface() error {
	ret := _mock.Called()
...
func (_c *MockNetworkConfigurer_SetupInterface_Call) Return(err error) *MockNetworkConfigurer_SetupInterface_Call {
	_c.Call.Return(err)
	return _c
}
